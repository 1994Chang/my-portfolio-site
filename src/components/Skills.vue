     ...
     <section id="skills">
            <div class="container">
                ...
                <div class="integration-list row justify-content-center py-5">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/react.svg" alt="vuejs">
                        <p class="skill-label">ReactJS</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/material-ui.svg" alt="material-ui">
                        <p class="skill-label">MaterialUi</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/redux.svg" alt="Redux">
                        <p class="skill-label">Redux</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/nextjs.svg" alt="NextJS">
                        <p class="skill-label">NextJS</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/typescript.svg" alt="Typescript">
        ...
        <section id="skills">
            <div class="container">
                ...
                <div class="integration-list row justify-content-center py-5">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/shopify.svg" alt="android">
                        <p class="skill-label">Shopify</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5">
